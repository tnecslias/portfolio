            ...
            <div className="mt-3 grid gap-5 md:grid-cols-2 lg:grid-cols-3">
              <section>
                ...
                <p className="mt-2 leading-7 text-slate-700">
                  6人チームのWebアプリユニットとして、社員スキル管理システムの開発に参加しました。大まかな依頼から質問確認書と要件定義書を作成し、画面遷移やデザインをチームで検討。見やすさを意識したデザイン案を提案、採用してもらい、画面を実装しました。
                </p>
                <ul className="mt-4 list-disc space-y-2 pl-5 text-sm leading-6 text-slate-700">
              ...
              <section>
                ...
                <p className="mt-2 leading-7 text-slate-700">
                  Djangoを使用した社員管理システムを個人開発しました。Djangoでの開発は初めてだったため、制作前にAIでチュートリアルを作成してもらい、基本的な構成や実装の流れを予習してから取り組みました。
                </p>
                <ul className="mt-4 list-disc space-y-2 pl-5 text-sm leading-6 text-slate-700">
