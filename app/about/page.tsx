  ...
  return (
    <section className="mt-10">
          ...
          <ul className="pl-5">
            ...
            <li className="list-none mt-8">
              ...
              <ul className="list-disc ml-6">
                ...
                <li>普段macOSで授業と開発を行っている</li>
              </ul>
            </li>
          </ul>
        </div>

        <div className="w-full md:w-[450px] flex-shrink-0 md:mt-24">
          <iframe
      ...
      <div className="mt-16 w-full">
        ...
        <p className="leading-8 max-w-4xl">
          ...
          そして、円周率100桁を覚えているほど記憶力には自信があり、高校時代には現代文でセンター試験で96点を取るなど、文章を読み解く力にも強みがあります。
