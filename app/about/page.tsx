  ...
  return (
    <section>
      <ul className="list-disc pl-5">
        ...
        <p>
        私は大学時代、体育会の部活動に打ち込みながら、プログラミングを学び、「継続する力」を身につけました。<br>
        ...
        学生時代に学んだ研究や制作内容として、GitやGitHubを使ったチーム開発も経験し、制作物をRenderとGitHubPagesにデプロイし、Webサイトを公開しました。 また、AdobeIllustratorでデザイン素材の制作なども行い、デザインと開発の両面でスキルを磨きました。
        そして、円周率100桁を覚えているほど記憶力には自信があり、高校時代には現代文でセンター試験96点を取るなど、文章を読み解く力にも強みがあります。これまでの経験で培った継続力・技術力・記憶力を活かし、今後も楽しみながら成長していきたいと考えています。
        </p>
      </ul>
    </section>
  );
